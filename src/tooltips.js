...
export const TOOLTIPS = {
  ...
  pregenerateWindows: {
    ...
    detailed: "オンにすると、本体のウィンドウが落ち着いたあとで設定画面と取扱説明書の画面を先に作っておき、実際に開いたときは数十msで表示されます。オフにすると、開いたその場で作るため初めての表示に数秒かかることがありますが、まだ開いていない画面ぶんのメモリ(実測で約160MB)を使わずに済みます。",
  },
  autoSaveEnabled: {
    category: "settings",
    minimalMode: "suppress",
