...
internal static class SettingsBridge
{
    ...
    /// </summary>
    // 「更新する」連打対策(docs/調査記録/点検-機能と動作.md「余裕があれば直すもの」)。
    ...
    // 無駄な通信・書き込みを避けるためC#側でも進行中の印で弾く。
    // 印は起動時の dist 修復(DistRepairFlow)と共有するため UpdateService が持つ
    // (UpdateService.TryBeginApply参照)。
