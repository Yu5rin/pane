...
- **指示しないかぎり外部と通信しません** — 使用状況の送信も、テーマのダウンロードも、画像アップロード連携もありません。設定の「更新を確認」ボタンを押したときだけ、新しい版の有無をこのリポジトリのリリースへ尋ねます
...
新しい版があれば、そのままダウンロードして入れ替えることもできます（ダウンロードしたZipはSHA256で照合します）。
起動しただけでは通信しません。
